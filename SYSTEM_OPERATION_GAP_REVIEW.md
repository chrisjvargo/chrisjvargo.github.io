...
| OPS005 | dv_publication_evidence | open_gap | hypothesis_status_counts={'unresolved_required_data_unavailable': 14}; gap_register_rows=14; mapped_unresolved_gaps=14/14; release_request_files=15/15; gap_register_md_exists=True | Acquire/verify required case-level data and model artifacts using `DV_EVIDENCE_GAP_REGISTER.md`, then regenerate the DV public release. |
