...
| OPS007 | deployment_state | open_gap | branch=main; working_tree_changes=M .gitignore \|  M Makefile \|  M SYSTEM_OPERATION_GAP_REVIEW.md \|  M dv_publication/root_cv_screenshot_manifest.csv \|  M dv_publication/root_cv_visual_qa_report.json \|  M src/site_visual_qa.py | Commit local changes, push, and let the GitHub Pages workflow deploy. |
